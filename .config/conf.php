...
// Configuration Variables
	...
	if ($xoopsConfig['language'] == 'french')
	  $GLOBALS["language"] = "fr";
	elseif ($xoopsConfig['language'] == 'english')
	  $GLOBALS["language"] = "en";	
...
// Global User Variables (used when $require_login==false)
	...
	//$GLOBALS["home_dir"] = XOOPS_ROOT_PATH . '/uploads/archives';
	$GLOBALS["home_dir"] = XOOPS_ROOT_PATH . '/'. $xoopsModuleConfig['home_dir'];
		
	// the url corresponding with the home directory: (no trailing '/')
	//$GLOBALS["home_url"] = XOOPS_URL . '/uploads/archives';
	$GLOBALS["home_url"] = XOOPS_URL . '/'. $xoopsModuleConfig['home_dir'];
	
	// show hidden files in QuiXplorer: (hide files starting with '.', as in Linux/UNIX)
	$GLOBALS["show_hidden"] = $xoopsModuleConfig['showhidden'];
